                ...
                if (result.Succeeded)
                {
                    ...
                    if (roleResult)
                    {
                        return new ResponseDto<object>
                        {
                            Success = true,
                            Data = null,
                            Message = "Kayıt Işlemi Başarılı Bir Şekilde Gerçekleştirilmiştir.",
                        };
                    }
                    else
                    {
                        return new ResponseDto<object>
                        {
                            Success = false,
                            Data = null,
                            Message = "Kullanıcı Oluşturuldu, Rol Ataması Yapılırken Bir Hata Oluştu.Lütfen Yetkiliye Başvurunuz.",
                            ErrorCode = ErrorCodes.BadRequest
                        };
                    }
