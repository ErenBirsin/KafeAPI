...
namespace KafeAPI.Application.Services.Concrete
{
    public class ReviewServices : IReviewServices
    {
        ...
        public ReviewServices(IGenericRepository<Review> genericRepository, IMapper mapper, IValidator<CreateReviewDto> createValidator, IValidator<UpdateReviewDto> updateValidator)
        {
            _reviewRepo = genericRepository;
            _mapper = mapper;
